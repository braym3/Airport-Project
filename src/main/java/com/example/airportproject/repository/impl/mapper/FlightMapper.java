...
public interface FlightMapper {
    ...
    @Select("SELECT id, airline_iata, dep_iata, arr_iata, status, aircraft_icao, flight_iata, dep_time, arr_time, duration FROM flights")
    @Results(id="flightResults", value = {
            ...
            @Result(property = "gate", column = "id", many = @Many(select = "selectGateForFlight"))
    })
    List<Flight> getAll();
